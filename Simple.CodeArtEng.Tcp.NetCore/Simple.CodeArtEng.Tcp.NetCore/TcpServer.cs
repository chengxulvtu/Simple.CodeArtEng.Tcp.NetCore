...
namespace CodeArtEng.Tcp
{
    ...
    public class TcpServerConnection : IDisposable
    {
        ...
        //{
        //    var other = (TcpServerConnection)obj;
        //    return ClientIPAddress.ToString() == other.ClientIPAddress.ToString() && ClientPort == other.ClientPort;
        //}

        //public override int GetHashCode()
        //{
        //    return ClientIPAddress.ToString().GetHashCode() + ClientPort.GetHashCode();
        //}
    }
}
